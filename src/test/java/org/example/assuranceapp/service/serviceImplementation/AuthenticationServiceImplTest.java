...
class AuthenticationServiceImplTest {
    ...
    void register_ShouldThrowException_WhenPhoneNumberIsInvalid() {
        Utilisateur user = new Utilisateur("test", "password", "str str", "test@example.com", 12345);
    ...
    void register_ShouldThrowException_WhenRequiredFieldsAreEmpty() {
        Utilisateur user = new Utilisateur("", "password", "str str", "test@example.com", 1234567890);
    ...
    void register_ShouldCallDaoRegister_WhenInputIsValid() {
        Utilisateur user = new Utilisateur("test", "password", "str str", "test@example.com", 1234567890);
    ...
    void login_ShouldReturnUser_WhenCredentialsAreCorrect() {
        ...
        Utilisateur mockUser = new Utilisateur("test", "password", " Str str", "test@example.com", 1234567890);
